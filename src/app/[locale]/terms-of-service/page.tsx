...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - EA Sports FC 27 Wiki",
    description: "Read the Terms of Service for EA Sports FC 27 Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - EA Sports FC 27 Wiki",
      description: "Terms and conditions for using EA Sports FC 27 Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using EA Sports FC 27 Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using EA Sports FC 27 Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and EA Sports FC 27 Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              EA Sports FC 27 Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
            ...
            <p>
              <strong>Important:</strong> EA Sports FC 27 Wiki is NOT affiliated with, endorsed by, or associated with
              Electronic Arts Inc. (EA), the developer and publisher of EA SPORTS FC. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by EA Sports FC 27 Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Electronic Arts Inc. (EA). We use such
            ...
            <ul>
              ...
              <li><strong>Availability:</strong> Release dates, editions, platforms, and game updates may change without notice. We are not responsible for access or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              The Website may contain links to third-party websites, including EA, Discord, social media platforms,
            ...
            <p>
              ...
              you and EA Sports FC 27 Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@easportsfc27.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@easportsfc27.wiki</a>
            </p>
            <p>
