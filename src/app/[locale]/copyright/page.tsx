...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - EA Sports FC 27 Wiki',
    description: 'Copyright and intellectual property information for EA Sports FC 27 Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - EA Sports FC 27 Wiki',
      description: 'Copyright and intellectual property information for EA Sports FC 27 Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 EA Sports FC 27 Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of EA Sports FC 27 Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              EA Sports FC 27 Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Electronic Arts Inc.</strong> - Developer and publisher of the EA SPORTS FC franchise</li>
              <li><strong>EA SPORTS FC</strong> - Football simulation game series by Electronic Arts</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>EA SPORTS FC</strong> - Trademark of Electronic Arts Inc.</li>
              <li><strong>EA SPORTS FC 27</strong> - Upcoming installment in the EA SPORTS FC franchise</li>
              <li><strong>EA Sports FC 27 Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with EA Sports FC 27 Wiki.
            </p>
            ...
            <p>
              ...
              EA Sports FC 27 Wiki<br />
              Email: <a href="mailto:dmca@easportsfc27.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@easportsfc27.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "EA Sports FC 27 Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: EA Sports FC 27 Wiki (easportsfc27.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@easportsfc27.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@easportsfc27.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@easportsfc27.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@easportsfc27.wiki</a>
            </p>
            <p>
